...
![Kenar Karşılaştırması ile Tespit](Images/EdgeMatching_1.webp)
...
![Haar Cascade ile Tespit](Images/HaarCascade_1.jpg)
...
![YOLO algoritması ile Tespit](Images/YOLO_2.jpg)

## Çıktı Örneği:

![YOLO örnek 1](Images/YOLO_1.jpg)
